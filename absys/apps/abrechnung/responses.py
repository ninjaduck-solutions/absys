...
class SaxMBSResponse(HttpResponse):
    ...
    TEMPLATE_RECHNUNG_EINRICHTUNG = '{% load abrechnung_tags %}{# 1 5 #}+0925{# 2 4 #}NEUE{# 3 6 #}ABSYS {# 4 6 #}SAXMBS{# 5 12, Punkt an Stelle 9#}{{ rechnungeinrichtung.nummer }}.000{# 6 7, lückenlos aufsteigende Nummer, führende Nullen #}{{ counter|stringformat:"+07d" }}{# 7 5 Leer #}     {# 8 70 Leer #}                                                                      {# 9 3 #}H  {# 10 2 leer #}  {# 11 Haushaltsjahr, letzte zwei Ziffern #}{{ rechnungeinrichtung.rechnung_sozialamt.startdatum|date:"y" }}{# 12 5 Kapitel #}{{ kapitel }}{# 13 2 leer #}  {# 14 5 Titel #}{{ rechnungeinrichtung.einrichtung.titel }}{# 15-25 89 leer #}                                                                                         {# 26 12 Buchungskennzeichen #}{{ rechnungeinrichtung.buchungskennzeichen|stringformat:"12s" }}{# 27 12 Buchungsbetrag ohne Punkte an bei Dezimalpunkten #}{{ rechnungeinrichtung.summe|decimal_ohne_punkt|stringformat:"+012d" }}{# 28 3 Währung #}{{ waehrung }}{# 29-30 54 leer #}                                                      {# 31 8 Faelligkeit DDMMYYYY#}{{ rechnungeinrichtung.datum_faellig|date:"dmY" }}{# 32-33 23 leer #}                       {# 34 7 Zahlungspartnernummer #}{{ rechnungeinrichtung.rechnung_sozialamt.sozialamt.zahlungspartnernummer }}{# 35-43 191 leer #}                                                                                                                                                                                               {# 44 1 "J" wenn BKZ vorhanden, sonst nicht #}{{ rechnungeinrichtung.buchungskennzeichen|yesno:"J,N" }}{# 45 1 ist fest #}N{# 46 2 Zahlungsanzeigeschlüssel #}{{ zahlungsanzeigeschluessel|stringformat:"02i" }}{# 47 1 leer #} {# 48 2 Mahnschlüssel #}{{ mahnschluessel }}{# 49 1 Zinsschlüssel #}{{ zinsschluessel }}{# 50-60 89 leer #}                                                                                         {# 61 8 Ziffer Ebene 1 #}{{ ebene_1 }}{# 62 8 leer #}        {# 63 10 leer #}          {# 64 20 leer #}                    {# 65-66 62 leer #}                                                              {# 67 1 SEPA #}{{ sepa }}{# 68-69 45 leer #}                                             {# 70 35 Verwendung: Sozialamt #}{{ rechnungeinrichtung.rechnung_sozialamt.name_sozialamt|stringformat:"35s" }}{# 71 35 Einrichtungsname #}{{ rechnungeinrichtung.name_einrichtung|stringformat:"35s" }}{# 72 35 Datum von bis #}VOM {{ rechnungeinrichtung.rechnung_sozialamt.startdatum|date:"d.m.Y" }} BIS {{ rechnungeinrichtung.rechnung_sozialamt.enddatum|date:"d.m.Y" }}      {# 73 35 leer (kann aber Verw.Zeck sein) #}                                   {# 74 1 leer #} {# 75 8 leer #}        '

    TEMPLATE_SICHERUNGSDATENSATZ = '{% load abrechnung_tags %}{# 1 5 #}+0925{# 2 4 #}EEEE{# 3 6 #}ABSYS {# 4 6 #}SAXMBS{# 5 12 Dateiname#}{{ rechnungsozialamt.nummer }}.DAT {# 6 7, lückenlos aufsteigende Nummer, führende Nullen #}{{ rechnungsozialamt.rechnungen_einrichtungen.count|add:1|stringformat:"+07d" }}{# 7-11 82 Leer #}                                                                                  {# 12 5 Mittelwert (abgerundet) aller Kapitel #}{{ rechnungsozialamt.mittelwert_kapitel|stringformat:"05d" }}{# 13 2 leer #}  {# 14 5 Mittelwert (abgerundet) aller Titel #}{{ rechnungsozialamt.mittelwert_titel|decimal_ohne_punkt|stringformat:"05d" }}{# 15-26 101 leer #}                                                                                                     {# 27 12 Mittelwert Buchungsbetraege (abgerundet) mit 00 am Ende #}{{ rechnungsozialamt.mittelwert_einrichtungssummen|stringformat:"+010i" }}00{# 28-75 678 leer #}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      '
