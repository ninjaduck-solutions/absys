...
These are the default settings in :file:`absys/manage.py`.
...
:py:class:`absys.config.settings.common.Common`.
...
.. list-table::
    ...
    * - ``STATIC_ROOT``
      - ``'<full path to absys>/static_root/'``
      - ``DJANGO_STATIC_ROOT``
...
:py:class:`absys.config.settings.databases.Databases`.

The following classes inherit from it:

* :py:class:`absys.config.settings.dev.Development`
* :py:class:`absys.config.settings.public.Production`
* :py:class:`absys.config.settings.public.Staging`
* :py:class:`absys.config.settings.test.Testing`
...
:py:class:`absys.config.settings.email.SMTP`
...
from :py:class:`absys.config.settings.email.Mailgun`
to use these settings.
...
from :py:class:`absys.config.settings.public.Raven`
to use these settings.
...
The class
:py:class:`absys.config.settings.public.Public`
...
from :py:class:`absys.config.settings.public.SSL`
to use these settings.
:py:class:`absys.config.settings.public.Production`
