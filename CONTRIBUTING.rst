...
<https://github.com/imtb/absys/issues>`_.
...
absys could always use more documentation, whether as
part of the official absys docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `absys` for
local development.

1. Fork the `absys` repo on GitHub.
2. Clone your fork locally:

    ::

       $ git clone git@github.com:your_name_here/absys.git
...
3. The pull request should work for Python 2.7 and 3.5. Check
   `Travis CI <https://travis-ci.org/imtb/absys/pull_requests>`_
